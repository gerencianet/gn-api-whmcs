...
function validationParamsCard($params)
{
    ...
    $birthDate = $params['paramsCartao']['dataNasce'];
    $cardNumber = str_replace(' ', '',($params['paramsCartao']['numCartao'].length >=14)? $params['paramsCartao']['numCartao']:$params['paramsCartao']['numCartaoMobile']);
    ...
    if (empty($errorMessages)) {
        ...
        if ($existCharge == false) {
            ...
            if ($resultCheck['code'] != 0) {
                ...
                $addTransactionValues['description']    = "Cartão Gerencianet: Cobrança gerada.";
        ...
        if ($permitionToPay == true) {
            ...
            if ($resultPaymentDecoded['code'] != 0) {
                ...
                $updateTransactionValues['description']    = "Cartão de crédito Gerencianet: Cobrança aguardando pagamento.";
