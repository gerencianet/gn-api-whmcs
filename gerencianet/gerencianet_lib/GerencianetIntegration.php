...
class GerencianetIntegration
{
	...
	public function testIntegration()
	{
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => "https://api.gerencianet.com.br/v1/authorize", // Rota base, homologação ou produção
	...
	public function pay_credit($charge_id, $customer, $message, $params)
	{
		...
		try {
			$api = new Gerencianet($options);
			$charge = $api->payCharge($chargeId, $body);
	...
	public function defineMethod($charge_id)
	{
		$options = GerencianetIntegration::get_gn_api_credentials();
