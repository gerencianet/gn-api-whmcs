...

{
    ...
    return array(
        ...
        'pixCert' => array(
            ...
            'FriendlyName' => 'Certificado de Autenticação <i class=" fas fa-question-circle " data-toggle="tooltip" data-placement="top" title="Insira o caminho do seu certificado .pem ou .p12 (Necessário somente no caso de utilização do Pix)"></i>',
...
function definedOpenFinancePayment($gatewayParams)
{
    ...
    //$existingOFCharge = getOFCharge($gatewayParams);
